    ...
    const containerData = [
        {
            ...
            card: [
                ...
                },
                {
                    ...
                    text: 'The magnificent Marundeeswarar Temple, in Tiruvanmiyur, near Chennai has the temple deity Shiva...',
        ...
        },
        {
            ...
            card: [
                ...
                },
                {
                    ...
                    text: 'Located in the town of Darasuram near Kumbakonam in Tamil Nadu, Airavatesvara temple is in...',
                ...
                <div className="container" key={index}>
                    <div className="row" style={{ marginTop: "30px" }}>
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-6" style={{ alignItems: 'stretch' }}>
                            <h6 style={{ marginTop: '15px', marginBottom: '15px', fontWeight: 'bold' }}>{data.title}</h6>
                            <p style={{ textAlign: 'justify', marginBottom: '20px', marginLeft: '10px' }} className='expant-text'>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{data.description1}
                                <br />
                                <br />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{data.description2}
                        ...
                        <h3 style={{ textTransform: "capitalize", textAlign: "center", margin: "40px 0" }}>{data.must}</h3>
                        <CardGroup className='d-flex gap-4'>
                            {data.card.map((card, cardIndex) => (
                                <Card key={cardIndex} className="border rounded-2 mb-4" style={{ width: "16rem" }}>
                                    <Card.Img variant="top rounded-2" src={card.imageSrc} style={{ height: "200px", objectFit: "cover" }} />
                                    <Card.Body>
                                        <Card.Title><h5>{card.title}</h5></Card.Title>
                                        <Card.Text style={{ paddingRight: "15px" }}>{card.text}</Card.Text>
                                        <Button variant="primary" className='button' >Read More</Button>
                                    </Card.Body>
                                </Card>
                            ))}
                        </CardGroup>
