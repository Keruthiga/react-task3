...
const placesData = [
    {
        ...
        data:[
            ...
            },
            {
                ...
                place: "Marundeeswarar Temple, Overview",
                describe1:`‘The magnificent Marundeeswarar Temple, in Tiruvanmiyur, near Chennai has the temple deity Shiva in the form of Marundeeswar or
                ...
                cities,`,
                describe2:`Glorified in the 7th-8th century by Nayanars (Saivite Saints), Tirugnana Sambandar, and Appar, the temple was expanded by the Chola
            ...
            },
            {
                ...
                place: "Breezy Beach, Overview",
                describe1:`Breezy Beach lays in the remote and serene neighbourhood of Valmiki Nagar in Chennai, Being smaller and less polluted, its a perfect
                ne looking for a peaceful evening.`,
                describe2: `This beach is not as popular and known 2s the Ellots beach, and is hence more quiet and peaceful. Evenings are very pleasant and
        ...
        data:[
            {
                ...
                place: "Dhanushkodi Temple, Overview",
                describe1: `Dhanushkodi was until a few years ago a wonderful temple on the southern tip of India. However, du to a natural calamity, the cyclone, it
                got completely washed away.`,
                describe2: `It holds the advantage of being on an island and is exquisitely covered by waters on all the four sides of it. It is sandwiched between the
            ...
            },
            {
                ...
                place: "Lakshmana Temple, Overview",
                describe1: `Lakshmana Tirtham had been constructed in the loving memory of Lord Lakshman, brother of Lord Rama. In order to offer sacred
                ...
                describe2: `Several wonderful sculptures of Lord Lakshman have been carved out from marble and the temple has the statues of lord Rama and
                which signifies the spirit of unitedness that exisited between them.`,
            },
            {
                imageSrc: require('../Home/Rameshwaram3..jpeg'),
                place: "Villoondi Tirtham, Overview",
                describe1: `Villoondi Tirtham is a beach which is also considered a sacred natural water body and a favourite amongst tourists. It also has a spring
                ...
                describe2: `Villoondi Theertham is situated about & km from the Remeswaram main bus stand. Besides its arresting views and silent tides, the place is
            ...
            },
            {
                ...
                place: "Rameshwaram Temple, Overview",
                describe1: `A perfect blend of mind-boggling architecture and spiritual significance, Rameshwaram Temple, also known as Ramanathaswamy
                ...
                treat for your eyes.`,
                describe2: `‘The lingam in the Remeshwaram Temple was installed by Lord Rama but, the construction was led by several rulers over the centuries.
        ...
        data:[
            {
                ...
                place: "Green Valley View, Overview",
                describe1: `Formerly known as Suicide point, the Green Valley View offers a breathtaking view of the plains, deep valleys and hills, The mesmerizing
                view of the Vaigai Dam is an unforgettable experience.On the way to the point, there are several shopsOn the way to the point, there are several shops It used to be known as suicide point because of the dangerous valley which is dense and deep;
                below the point of more than 5000 feet drop.`,
                describe2: `Located at a distance of 5.5 km from the Kodaikanal Lake, the Green Valley View not just offers a gorgeous view, On the way to the point, there are several shops On the way to the point, there are several shops but s also surrounded by
            ...
            },
            {
                ...
                place: "Kodai Lake, Overview",
                describe1: `Kodaikanal Lake is a manmade lake in the Kodaikanal city which is also known as Kodai Lake. Vera Levinge was the man responsible for
                eativity and resources of this lake amidst Kodaikanal town. This lake was developed by the British and early missionaries from the USA`,
                describe2: `‘The star-shaped lake is centrally located in Kodaikanal and is surrounded by the rich green Palani Hills Range the main watershed for
            ...
            },
            {
                ...
                place: "Bear Shola Falls, Overview",
                describe1: `Located at 3 mere distance of 2 kilometres from the Kodaikanal Lake, the Bear Shola Falls is 3 popular picnic spot in the region. This
                ...
                describe2: `Wrapped with dense forests coupled with the chirping of birds, Bear Shola Fals is 2 little that it was a favourite haunt of a bear who used to frequent this water that it was a favourite haunt of a bear who used to frequent this water heaven. Also, the forest area of the Westen
            ...
            },
            {
                ...
                place: "Pillar Rocks, Overview",
                describe1: `Situated in the ‘Princess of Hill stations, Kodaikanal, the Pillar Rocks have become a lovely picnic spot. Constituting 2 beautiful mini
                ...
                describe2: `The pillars are famous for providing bird's view of nearby surroundings. The chambers between these two massive rocks are called the
        ...
        data:[
            {
                ...
                place: "Nilgiri Mountain Railway, Overview",
                describe1: `Nilgiri Mountain Railway, also known as Toy Train in Ooty, is one of the key attractions of the popular hill station Ooty. Such is the train's
                ...
                describe2: `The Toy Trein covers a distance of total 46 km in 2 span of 5 hours and takes one through 2 truly spectacular journey filed with
            ...
            },
            {
                ...
                place: "Ooty Botanical Garden, Overview",
                describe1: `Ooty Botanical Gardens lie on the lower slopes of the Doddabetta pezk, the Goverment Botanical Garden is a splendid garden in
                ...
                describe2: `Visitors are greeted with astounding colourful natural beauty from the moment they pass through the gates. For more than 160 years,
            ...
            },
            {
                ...
                place: "Emerald Lake, Overview",
                describe1: `Emerald Lake is situated in Emerald Village, around 20-22 kilometres from the mein city of Ooty and is 2 part of the Silent Valley National
                ...
                describe2: `It is one of the unexplored and virgin places of the South Indian hill station, not yet encroached by the masses of tourists that visit the
            ...
            },
            {
                ...
                place: "Dolphin's Nose , Overview",
                describe1: `Located about 12 km away from Coonoor is the Dolphin's Nose about 1,500 meters above sea level, The tip of the peak of this
                ...
                describe2: `tis set amidst the rolling hills of the Nilgiris Hill (or the Blue Mountains). The gigantic rock formation is entirely unprecedented, There
        ...
        data:[
            {
                ...
                place: "Kanyakumari Beach, Overview",
                describe1: `Located in the southemmost part of India, Kanyakumari beach with its beautiful hue-changing beaches, the confluence of three water
                ...
                day's weather.`,
                describe2: `The beach is not conducive to swim or surf as the water as the sea is rough and the beach is rocky.To enjoy the best view, you can visit the
            ...
            },
            {
                ...
                place: "Vivekananda Memorial, Overview",
                describe1: `The magnificent Vivekananda Rock Memorial is located on a small island off Kanyakumari. It has the picturesque Indian Ocean in its
                ...
                describe2: `This statue was built in the year 1970 on the island situated in Vavathurai, but on the site where Vivekananda attained enlightenment.
            ...
            },
            {
                ...
                place: "Thiruvalluvar Status, Overview",
                describe1: `Dedicated to the accomplished philosopher and poet Thiruvalluvar, this beautiful statue finds itself on a small island near Kanyakumari.
                ...
                describe2: `This monument stands tall at a mighty height of 133 feet and is perched upon a 38-foot pedestal. The pedestal's height represents the 38
            ...
            {
                imageSrc: require('../Home/kanyakumari1 (4).jpeg'),
                place: "Thirparappu Falls, Overview",
                describe1: ` Located at a distance of about 55 kilometers from Kanyakumari, the cascading waters of the Thirparappu Falls make up for an
                ...
                paradise.`,
                describe2: `These falls are 2 unique combination of streams that flow together to form a magnificent waterfall. The containment below is no less
        ...
        data:[
            {
                ...
                place: "Sarangapani Temple, Overview",
                describe1: `Sarangapani Temple, 2n ancient temple dedicated to Lord Vishnu, is located in the town of Kumbakonam in the South-indian state of
                ...
                regarded as one of the five sacred temples`,
                describe2: `
    `,
            },
            {
                imageSrc: require('../Home/kumbakonam1 (2).jpeg'),
                place: "Nageswaran Temple, Overview",
                describe1: `Constructed as a chariot, the Nageswaran temple is an important Shaivite temple. A piece of genius Chola architecture, it is an
                ...
                describe2: `There are many inscriptions associated with the temple indicating contributions from Cholas, Thanjavur Nayaks and Thanjavur Maratha
            ...
            },
            {
                ...
                place: "Adi Kumbeshwara Temple, Overview",
                describe1: `Believed to have been constructed in the 7th century AD by the Cholas, Adi Kumbeshwara Temple is one of the grandest and the oldest
                ...
                . unique Shiva lingam.`,
                describe2: `The temple complex covers an area of 30,181 sq ft (2803.9 m2) and houses four gateway towers known as gopurams. The tallest is the
            ...
            },
            {
                ...
                place: "Airavatesvara Temple, Overview",
                describe1: `Located in the town of Darasuram near Kumbakonam in Tamil Nadu, Alravatesvara Temple is a revered Hindu temple and a UNESCO
        ...
        data:[
            {
                ...
                place: "Vaigai Dam, Overview",
                describe1: ` Vaigai Dam, a magnificent human-made structure, is constructed over River Vaigai near Andipatti, Theni District in the South Indian State
                ...
                describe2: `On one side of the dam is 2 beautiful garden known as Little Brindavan maintained by the management for the visitors. Little Brindavan
            ...
            },
            {
                ...
                place: "Meghamalai, Overview",
                describe1: `Often known as the “High Wavy Mountains, Meghamalai is 2 petit yet beautiful place located in the Wester Ghats in the state of Tamil
                ...
                describe2: `The Meghamalai region of the Wester Ghats is 2 paradise unexplored even by the people of Tamil Nadu. The local Tamil language also
            ...
            },
            {
                ...
                place: "Samanar Hills, Overview",
                describe1: `Located in Keelakuyilkudi vilage near Madurai, Samanar Hills or Samanar Malai is 2 beautiful hill rock complex which was originally home
                ...
                describe2: ` There is no better place to escape the heat than this picturesque getaway surrounded by nature. Meghamalai is one of the best places to
            ...
            },
            {
                ...
                place: "Thirumalai Nayakar, Overview",
                describe1: `Thirumalai Nayakar Palace was erected in 1636 AD in the city of Madurai, by King Thirumalai Nayak. The palace depicts the perfect
        ...
        data:[
            {
                ...
                place: "Pagoda Point,, Overview",
                describe1: `Located in the eastern part of the Yercaud Hills, Pagoda point is a beautiful viewpoint where one is treated to a panoramic view of the entire town of Salem as well as the neighbouring village of Kakambadi. The twists and turns of the 21 hairpin bends of Yercaud can be seen from this spot as they envelop themselves around the hills. The mysterious piles of stones arranged in the form of a pyramid resembling a Pagoda give the location its unique name. These stones are believed to be placed here by local tribes`,
                describe2: `Between the Pagodas here lies a temple devoted to Lord Rama. One can indulge in the amazing natural beauty of the spot and the scenery of the Eastern Ghats, with the greenery growing within the rugged terrains of the hills, entwined with sights of the craggy cliffs.`,
            },
            {
                imageSrc: require('../Home/yercaud1 (2).jpeg'),
                place: "Botanical Garden, Overview",
                describe1: `Any tourist who is interested in gods gift to this planet, the wondrous flora, and in knowing about various species of plants must make it a point to visit the orchid garden and the green house in the Botanical garden.`,
                describe2: `Yercaud is the place where the famous Kurinji flower blooms in plenty and the specialty of this flower is that it will bloom only once in twelve years. The National Orchidarium which is located 2 km from the Emerald Lake has a wide variety of orchids which includes 30 orchid species that are exclusively found here. Many endangered species of orchids are persevered in this orchidarium which is ranked the third largest of all the orchidariums in India.`,
            },
            {
                imageSrc: require('../Home/yercaud1.(4).jpeg'),
                place: "Lady,s Seat, Overview",
                describe1: `Lady's Seat is a viewpoint that overlooks the winding ghat road and offers a spectacular view of Mettur Dam and Salem town. Besides, the place also houses a viewing tower, which is equipped with a telescope to enjoy the beautiful view. This viewing tower is open for visitors only during the daytime. Lady's Seat, Gent's Seat and Children's Seat, located to the south-west of Shevaroy Hill, are the names given to a group of rocks located on the Yercaud Hills`,
                describe2: `It is believed that an English lady used to spend her evenings at this place watching the beautiful view of this rock. For those interested in a closer view, there's a mounted telescope. Swing it to your extreme right to see the Mettur Dam on the Cauvery River. Great shots of the river can be had from this spot in the late afternoon when the sun's rays are reflected in its waters`,
            },
            {
                imageSrc: require('../Home/yercaud1.(3).jpeg'),
                place: "Emerald Lake, Overview",
                describe1: `The most alluring aspect of Yercaud is its big yet natural lake very popularly known as the Emerald Lake. Surrounded by some wonderful cloud-peaked hills and a well persevered garden on its banks, this lake is a feast for the eyes.`,
                describe2: `There is a floating fountain in the lake and boating facilities are available at a reasonable rate. Self-driven as well as rowing boats can be chosen according to your comfort and intersts. A nominal amount is collected as caution fee before issuing the boats and austere safety measures are followed by the authorities.`,
            }
...
function PlacesToVisit1() {
    return (
        <>
            {placesData.map((city, cityIndex) => (
                <div className="container" key={cityIndex}>
                    <h2 style={{textAlign:"center"}}>{city.placename}</h2>
                        ...
                        <div className='row mt-5' key={dataIndex} style={{justifyContent:"center"}}>
                            {dataIndex % 2 === 0 ? (
                                ...
                                <>
                                    ...
                                    <div className="col-xl-3 col-lg-3 col-md-3">
                                        <img src={data.imageSrc} alt="img" className="img-fluid" style={{height:"15rem", marginTop:'15px'}} />
                                    </div>
                                </>
                            )}
                        </div>
